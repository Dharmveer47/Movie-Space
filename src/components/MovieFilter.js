  ...
  return (
    <div>
      <div className="p-10 flex justify-center w-[90%] m-auto h-8 bg-gradient-to-r from-gray-100 to-gray-500 rounded-2xl my-2">
        ...
        "
          >
            <div className="hover:bg-gray-900 hover:text-gray-50 px-2 rounded-md w-[100%] text-lg mdx:text-sm">
              Tody
            </div>
            <div className="mx-1 ">
              {" "}
          ...
          <div className="hover:bg-gray-900 hover:text-gray-50 px-2 rounded-md whitespace-nowrap ">
            This Week
          </div>
        </div>
    ...
    <div className={`${search?'hidden': ''}`}>
      <div className=" flex items-center justify-evenly w-[90%]  mx-auto mb-10 h-8 bg-gradient-to-r from-gray-100 to-gray-500 rounded-2xl my-2">
        ...
        <div className="flexCC">
          <button
            onClick={() => Dec()}
            className="flexCC  active:text-gray-600 hover:text-white cursor-pointer  "
          >
            {" "}
          ...
          <div
            ...
            } px-2 mx-1 rounded-md font-bold `}
          >
            {next}
          </div>
          <button
            onClick={() => Inc()}
            className="flexCC active:text-gray-700 hover:text-white cursor-pointer"
          >
            {" "}
